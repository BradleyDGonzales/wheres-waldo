...
const MapTwo = ({ mapData }) => {
    ...
    useEffect(() => {
        const getCoords = async () => {
            ...
            dataCoords = tempArray.filter((data) => data.id === 'maptwo');
        }
        getCoords();
    },);
        ...
        <>
            ...
            <div className='container'>
                ...
                <div className='map'>
                    ...
                    <img onClick={(e) => charactersPopUp(e)} className='currentMap' id="maptwo" src={maptwo} alt='maptwo' />
                    <p id='x'></p>
                    <p id='y'></p>
                </div>
            </div >
